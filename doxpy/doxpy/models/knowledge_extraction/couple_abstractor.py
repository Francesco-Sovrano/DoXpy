...
class FramenetAbstractor(CoupleAbstractor):
	...
	def abstract_couple(self, couple):
		...
		lu_argmax, lu_confidence = self.get_most_similar_idx_n_label([couple_predicate], self.LU_KEY_LIST)[0]
		...
		concept_argmax, concept_confidence = self.get_most_similar_idx_n_label([fragment], target_list)[0]
