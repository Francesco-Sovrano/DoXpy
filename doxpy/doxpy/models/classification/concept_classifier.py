...
class ConceptClassifier(SentenceClassifier):
	...
	def get_concept_dict(self, doc_parser: DocParser, concept_counter_dict=None, similarity_threshold=None, with_numbers=True, size=None, remove_stopwords=True, lemmatized=True, tfidf_importance=None, concept_label_filter=None, concept_id_filter=None):
	...
	def annotate(self, doc_parser: DocParser, similarity_threshold=None, max_concepts_per_alignment=1, tfidf_importance=None, concept_id_filter=None):
